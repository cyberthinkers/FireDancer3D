...
case class Matrix3(
  ...
  def rotate(angle: Double, v: Vector3): Matrix3 = {
    ...
    Matrix3(n00, n01, n02, n10, n11, n12, n20, n21, n22)
  }

  def rotateX(angle: Double): Matrix3 = {
    val cosAngle = Math.cos(angle)
    val sinAngle = Math.sin(angle)
    ...
    Matrix3(m00, n01, n02, m10, n11, n12, m20, n21, n22)
  }
  
  def rotateY(angle: Double): Matrix3 = {
    val cosAngle = Math.cos(angle)
    val sinAngle = Math.sin(angle)
    ...
    Matrix3(n00, m01, n02, n10, m11, n12, n20, m21, n22)
  }
  
  def rotateZ(angle: Double): Matrix3 = {
    val cosAngle = Math.cos(angle)
    val sinAngle = Math.sin(angle)
