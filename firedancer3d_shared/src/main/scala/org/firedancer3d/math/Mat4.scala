...
case class Mat4 (
  ...
  def rotate(angle: Double, v: Vec3): Mat4 = {
    ...
    Mat4(n00, n01, n02, m03, n10, n11, n12, m13, n20, n21, n22, m23, m30, m31, m32, m33)
  }
  
  def rotateX(angle: Double): Mat4 = {
    val cosAngle = Math.cos(angle)
    val sinAngle = Math.sin(angle)
    ...
    Mat4(m00, n01, n02, m03, m10, n11, n12, m13, m20, n21, n22, m23, m30, n31, n32, m33)
  }
  
  def rotateY(angle: Double): Mat4 = {
    val cosAngle = Math.cos(angle)
    val sinAngle = Math.sin(angle)
    ...
    Mat4(n00, m01, n02, m03, n10, m11, n12, m13, n20, m21, n22, m23, n30, m31, n32, m33)
  }
  
  def rotateZ(angle: Double): Mat4 = {
    val cosAngle = Math.cos(angle)
    val sinAngle = Math.sin(angle)
    ...
    Mat4(n00, n01, m02, m03, n10, n11, m12, m13, n20, n21, m22, m23, n30, n31, m32, m33)
  }
}
